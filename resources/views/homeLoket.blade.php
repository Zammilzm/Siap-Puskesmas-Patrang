...
<body style="background-color:#cfd8dc;">
	...
	<ul id="slide-out" class="side-nav fixed">
		...
		<li><a href="{{URL('homeLoket')}}" class="waves-effect active" ><i class="material-icons">home</i>HOME</a></li>
		<li><div class="divider"></div></li>
		<li><a href="{{URL('pasien')}}" class="waves-effect" ><i class="material-icons active">face</i>PENGELOLAAN PASIEN</a></li>
		<li><div class="divider"></div></li>
		<li>
		...
		<div class="row">
			<div class="col s10 offset-s2">
				<h1 class="welcome-user">
					SELAMAT DATANG <br> <span style="color:#004d40;">LOKET</span>
				</h1>
			</div>
		</div>
		<div class="row">
			<div class="col s10 offset-s2">
				<a class="waves-effect waves-light btn-large">
					<i class="material-icons right">face</i>PENGELOLAAN PASIEN
				</a>
				<a class="waves-effect waves-light btn-large">
					<i class="material-icons right">language</i>PENGELOLAAN PENDAFTARAN
				</a>
			</div>
		</div>
		<div class="row">
			<div class="col s10 offset-s2">
				<a class="waves-effect waves-light btn-large">
					<i class="material-icons right">work</i>ADMINISTRASI RAWAT INAP
				</a>
				<a class="waves-effect waves-light btn-large">
					<i class="material-icons right">shop</i>LIHAT BPJS
				</a>
			</div>
		</div>
		<div class="row">
