...
<body style="background-color:#cfd8dc;">
	...
	<div class="container">
		<div class="row">
			<form method="POST" class="col s11 offset-s2" action="{{  url('/update/administrasi/'.$dataAdministrasi->id_pembayaran_inap) }}">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
				{{method_field('put')}}
				{{ csrf_field() }}
				<h2 style="text-decoration:underline;">ADMINISTRASI RAWAT INAP</h2>
				<div class="row">
				...
				<div class="row">
					<div class="input-field col s10">
						<input id="icon_telephone" type="number" class="validate" name="total_pembayaran" value="{{$dataAdministrasi->total_pembayaran}}">
				...
				<div class="row">
					<div class="col-md-7 offset-s2">
						...
						<br>
						<a href="{{URL('administrasiRawatInap')}}" class="btn btn-primary" >Batal</a>
					</div>
				</div>
			</form>
		</div>
