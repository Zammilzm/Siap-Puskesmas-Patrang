...
<body style="background-color:#cfd8dc;">
	...
	<div class="container">
		<div class="row">
			<form method="POST" class="col s11 offset-s2" action="{{ url('/update/'.$dataPasien->id_pasien) }}">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
				{{method_field('put')}}
				{{ csrf_field() }}
				<h2 style="text-decoration:underline;">EDIT PASIEN</h2>
				<div class="row">
					<div class="row">
						<div class="input-field col s10">
							<input id="icon_telephone" type="text" class="validate" name="id_pasien"
							value="{{$dataPasien->id_pasien}}"  required disabled>
							<label for="idpasien">ID Pasien</label>
						</div>
					</div>
					<div class="row">
						<div class="input-field col s10">
							<input id="icon_telephone" type="number" class="validate" name="no_ktp" 
							value="{{$dataPasien->no_ktp}}"  required >
							<label for="Noktp">NO KTP</label>
						</div>
					</div>
					<div class="row">
						<div class="input-field col s10">
							<input id="icon_telephone" type="number" class="validate" name="no_kk"
							value="{{$dataPasien->no_kk}}" required >
							<label for="Nokk">NO KK</label>
						</div>
					</div>
					<div class="row">
						<div class="input-field col s10">
							<input id="icon_telephone" type="text" class="validate" name="nama_pasien"
							value="{{$dataPasien->nama_pasien}}" required >
					...
					<div class="row">
						<div class="input-field col s10">
							...
							<textarea  id="icon_telephone" type="text" class="validate" name="alamat" 
							required >{{$dataPasien->alamat}}</textarea>
					...
					<div class="row">
						<div class="input-field col s10">
						<p>Tanggal Lahir</p>
							<input id="icon_telephone" type="date" class="validate" name="tanggal_lahir" 
							value="{{$dataPasien->tanggal_lahir}}" required >

						</div>
					</div>
					<div class="row">
						<div class="input-field col s3">
							@if($dataPasien->golongan_darah=='A')
							<p>
							...
							@endif
							@if($dataPasien->golongan_darah=='B')
							<p>
								<input type="radio" id="test1" name="golongan_darah" value="A" >
								<label for="test1">A</label>
							</p>
							<p>
								<input type="radio" id="test2" name="golongan_darah" value="B" checked>
								<label for="test2">B</label>
							</p>
							<p>
								<input type="radio" id="test3" name="golongan_darah" value="AB" >
							...
							@endif
							@if($dataPasien->golongan_darah=='O')
							<p>
								<input type="radio" id="test1" name="golongan_darah" value="A" >
								<label for="test1">A</label>
							</p>
							...
							<p>
								<input  type="radio" id="test4" name="golongan_darah" value="O" checked>
								<label for="test4">O</label>
							</p>
							@endif
							@if($dataPasien->golongan_darah=='AB')
							<p>
								<input type="radio" id="test1" name="golongan_darah" value="A" >
								<label for="test1">A</label>
							</p>
							...
							<p>
								<input type="radio" id="test3" name="golongan_darah" value="AB" checked>
								<label for="test3">AB</label>
							</p>
							<p>
								<input  type="radio" id="test4" name="golongan_darah" value="O">
